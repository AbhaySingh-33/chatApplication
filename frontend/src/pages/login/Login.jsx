...
const Login = () => {
	...
	return (
		<div className="min-h-screen flex justify-center items-center bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 px-4 relative overflow-hidden">
			...
			<div className="w-full max-w-md relative z-10">
				...
				<div className="text-center mb-8 animate-fade-in-down">
					...
					<h1 className="text-4xl font-bold text-white mb-2 animate-fade-in">Welcome Back</h1>
					<p className="text-blue-200 animate-fade-in delay-200">Sign in to continue your conversations</p>
				</div>
