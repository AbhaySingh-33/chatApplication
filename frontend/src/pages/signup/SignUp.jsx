            ...
            <div className="w-full max-w-sm p-6 rounded-lg shadow-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-10 bg-gradient-to-br from-slate-900/30 to-slate-700/20">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mt-4 flex flex-col items-center">
                        <label className="label">
                            <span className="text-base text-white mb-2">Profile Picture (optional)</span>
                        </label>
						<img 
							src={preview} alt="Avatar" 
							className="w-14 h-14 rounded-full object-cover border-2 border-gray-400 cursor-pointer transition hover:opacity-80"
                    ...
                    <Link
                        to={"/login"}
                        className="text-sm hover:underline text-blue-400 mt-9 inline-block"
                    >
